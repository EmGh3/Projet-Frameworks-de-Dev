...
namespace ERP_Project.Controllers
{
    ...
    public class ProjectController : Controller
    {
        ...
        /*public async Task<IActionResult> ProjectList()
        {
            ...
            var managerJson = HttpContext.Session.GetString("User");
            var EmployeeId = JsonConvert.DeserializeObject<Employee>(managerJson).Id;
            var projectCount = _projectManagerService.GetProjectCountForUser(EmployeeId);
            ViewBag.ProjectCount = projectCount;
            var completedProjectsCount = await _projectManagerService.GetCompletedProjectsCountForUserAsync(EmployeeId);
            ViewBag.CompletedProjectsCount = completedProjectsCount;
            var delayedProjectsCount = await _projectService.GetDelayedProjectsCountForUserAsync(EmployeeId);
            ViewBag.DelayedProjectsCount = delayedProjectsCount;
            var projects = await _projectService.GetProjectsByEployeeAsync(EmployeeId);
            return View(projects);
        }*/
        // GET: Project/Details/{id}
    }
